...
<ss:site var="site">
	<div class="top_box">
		...
		<div class="search">
			<span style="display: inline-block; width:261px; background: url('/style/image/register_banner.png') no-repeat; position: relative; left: 40px; height: 31px; top: -10px;"></span>
