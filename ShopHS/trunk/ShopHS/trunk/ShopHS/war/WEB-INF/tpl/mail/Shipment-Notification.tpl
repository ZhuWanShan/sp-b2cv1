  ...
  <tr>
    <td colspan="3">
      <table width="700" cellspacing="0" cellpadding="0" border="0" align="center">
        <tbody>
        <tr>
         <td> <img board="0" title="Joygown.com Logo" alt="Joygown.com logo" 

src="http://www.joygown.com/style/image/logo.png" > </td>
			...
			${order.shippingMethod}
                    ...
                    <td width="15"> </td>
                      <td width="80" align="left"> <strong style="COLOR: #000">Tracking</strong> </td>
						<td width="170" align="left">
                      <strong><a href="http://www.joygown.com/uc/orderDetails?id=${order.name}">My Order</a></strong>
...
HEIGHT: 18px">
                  <table width="100%" cellspacing="0" cellpadding="0" border="0" style="FONT-SIZE: 12px">
                    ...
                    <tr align="left">
                      <td width="22"> </td>
                      <td width="594"> <a href="http://www.joygown.com/${item.product.name}" 
...
href="http://www.joygown.com/uc/orderDetails?id=${order.name}" style="COLOR: #1e4e8e; TEXT-DECORATION: none" 
...
href="http://www.joygown.com/uc/helpCenter/more-2" style="COLOR: #1e4e8e; TEXT-DECORATION: none" 
...
href="http://www.joygown.com/uc/helpCenter/more-4" style="COLOR: #1e4e8e; TEXT-DECORATION: none" 

target="_blank">Return Exchange</a> policy.</p>
                  <p style="LINE-HEIGHT: 14px; MARGIN: 10px 0px">For all other 
                  questions, visit our <a href="http://www.joygown.com/uc/helpCenter/hcIndex" style="COLOR: #1e4e8e; 
...
or customs duties?</strong> </p>
                  <p style="LINE-HEIGHT: 14px; MARGIN: 10px 0px">Joygown.co.uk 
...
customer  service?</strong> </p>
                  ...
                  any order, just log in to <a href="http://www.joygown.com/uc/orderDetails?id=${order.name}" 
...
<em>service@joygown.com</em>.</p> </td>
                <td width="22"> </td> </tr>
              <tr>
                <td height="22"></td> 
				</tr> </tbody> </table>
      ...
      <table width="700" cellspacing="0" cellpadding="0" border="0" align="center">
        ...
        <tr valign="top">
          ...
          <td height="50" style="COLOR: #646464; FONT-SIZE: 12px"> <strong>PLEASE 
            ...
            email. If you have any questions, please send Email to: <em>service@joygown.com</em>. Thank you for your 
